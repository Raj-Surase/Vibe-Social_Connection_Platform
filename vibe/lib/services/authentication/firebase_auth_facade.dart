...
import "package:vibe/Domain/Authentication/auth_value_failures.dart";
...
class FirebaseAuthFacade implements IAuthFacade {
  ...
  Future<Either<AuthFailures, Unit>> registerWithEmailAndPassword(
    ...
    final emailAddressString = emailAddress!.valueObject!.fold(
        (l) => throw UnExpectedValueError(l as AuthValueFailures?), (r) => r);
    final passwordString = password!.valueObject!.fold(
        (l) => throw UnExpectedValueError(l as AuthValueFailures?), (r) => r);
    try {
